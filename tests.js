...
describe("Colecciones en JS: Array", () => {
    ...
    it("Nos permiten acceder a cada elemento del array", () => {
        ...
        let fruta1 = fruits[0];
        let fruta3 = fruits[3];
        expect(fruta1).to.equal("Piña");
        expect(fruta3).to.equal("Melón");
    })
...
describe("Operaciones iterables", () => {
    ...
    it("filtrando planetas", () => {
        ...
        // puedes utilizar la función .endsW(ith para comprobar si un string termina por una letra
